...
public class MenuViewHorizontal : MenuView
{
    ...
    public TextAnchor viewAnchor = TextAnchor.LowerCenter;
    ...
    void Start()
    {
        ...
        if (fillScreen) { viewWidth = canvas.GetComponent<RectTransform>().sizeDelta.x; }
        //Setup textboxes
